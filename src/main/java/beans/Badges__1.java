...
public class Badges__1 {

    @SerializedName("attachmentsByType")
    @Expose
    private AttachmentsByType__1 attachmentsByType;
    ...
    public AttachmentsByType__1 getAttachmentsByType() {
        return attachmentsByType;
    }

    public void setAttachmentsByType(AttachmentsByType__1 attachmentsByType) {
    ...
    public String toString() {
        ...
        sb.append(Badges__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Badges__1) == false) {
            return false;
        }
        Badges__1 rhs = ((Badges__1) other);
