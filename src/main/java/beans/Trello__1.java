...
public class Trello__1 {
    ...
    public String toString() {
        ...
        sb.append(Trello__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("board");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Trello__1) == false) {
            return false;
        }
        Trello__1 rhs = ((Trello__1) other);
