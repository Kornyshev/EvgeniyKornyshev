...
public class TrelloBoardWithUpdates {
    ...
    public String toString() {
        ...
        sb.append(TrelloBoardWithUpdates.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrelloBoardWithUpdates) == false) {
            return false;
        }
        TrelloBoardWithUpdates rhs = ((TrelloBoardWithUpdates) other);
