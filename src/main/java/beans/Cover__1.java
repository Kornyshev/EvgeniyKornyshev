...
public class Cover__1 {
    ...
    public String toString() {
        ...
        sb.append(Cover__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cover__1) == false) {
            return false;
        }
        Cover__1 rhs = ((Cover__1) other);
